...
Description: Простой способ добавить код на сайт для отслеживания(валидации) и инструментов разработчиков.
Yandex webmaster, Google webmaster, Bing webmaster, Mail webmaster, Yandex Metrika, Google Analytics
Plugin URI: http://vcard.dd-l.name/wp-plugins/
Tags: dl, Yandex, Google, Bing, Mail, Yandex Metrika, Google Analytics
Version: 0.1.2
...
function dl_verification_menu() {
	add_menu_page('DL-Verification', 'DL Verification', 'administrator', 'dl-verification', 'baw_settings_page', 'dashicons-chart-area', 81);
	add_action( 'admin_init', 'register_mysettings' );
}

function dl_verification_settings_link($links) {
  $settings_link = '<a href="admin.php?page=dl-verification">Настройки</a>';
...
<form method="post" action="options.php">
    ...
    <tr valign="top">
		...
		<code>&lt;meta name="yandex-verification" content="<?php echo get_option('YandexVerification'); ?>" /&gt;</code> - код добавлен в header сайта
		...
		<p><a href="http://webmaster.yandex.ru/sites/" target="_blank">Мои сайты</a> | <a href="http://webmaster.yandex.ru/site/add.xml" target="_blank">Добавить сайт</a></p>
	</td></tr>
    ...
    <tr valign="top">
		...
		<code>&lt;meta name="google-site-verification" content="<?php echo get_option('GooglVerification'); ?>" /&gt;</code> - код добавлен в header сайта
    ...
    <tr valign="top">
		...
		<code>&lt;meta name="msvalidate.01" content="<?php echo get_option('BingVerification'); ?>" /&gt;</code> - код добавлен в header сайта
    ...
    <tr valign="top">
		...
		<code>&lt;meta name="wmail-verification" content="<?php echo get_option('MailVerification'); ?>" /&gt;</code> - код добавлен в header сайта
		...
		<p><a href="http://webmaster.mail.ru/" target="_blank">Мои сайты</a></p>
	</td></tr>
	...
	<tr valign="top">
		...
		<p><a href="https://metrika.yandex.ru/list/" target="_blank">Все cчётчики</a> | <a href="https://metrika.yandex.ru/add/" target="_blank">Добавить счётчик</a> | <a href="https://metrika.yandex.ru/stat/?counter_id=5265289" target="_blank">Демо-доступ без регистрации</a></p>
	</td></tr>
	...
	<tr valign="top">
		...
		<p><a href="https://www.google.com/analytics/web/" target="_blank">Все аккаунты</a> | <a href="https://www.google.com/analytics/web/?hl=ru&pli=1#management/Settings/a34977198w62688226p64265043/%3Fm.page%3DNewAccount/" target="_blank">Создать новый аккаунт</a></p>
	</td></tr>
	</table>
...
function wp_head_verification_code() {
	echo '<meta name="yandex-verification" content="' . get_option('YandexVerification') . '" />';
	echo '<meta name="google-site-verification" content="' . get_option('GooglVerification') . '" />';
	echo '<meta name="msvalidate.01" content="' . get_option('BingVerification') . '" />';
	echo '<meta name="wmail-verification" content="' . get_option('MailVerification') . '" />';
}
add_action("wp_head", "wp_head_verification_code");

function wp_footer_verification_code() {
	echo get_option('YandexMetrika');
	echo get_option('GoogleAnalytics');
}
add_action("wp_footer", "wp_footer_verification_code");