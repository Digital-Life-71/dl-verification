...
function dl_verification_menu() {
	add_menu_page('dl-verification', 'DL Verification', 'administrator', 'dl-verification/options-page.php', '', 'dashicons-chart-area');
...
function dl_verification_wp_head_code() {
...
add_action("wp_head", "dl_verification_wp_head_code");


function dl_verification_wp_footer_code() {
	echo get_option('YandexMetrika');
	echo get_option('GoogleAnalytics');
}

add_action("wp_footer", "dl_verification_wp_footer_code");